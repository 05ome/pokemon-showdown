export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	blastoisemega: {
		...
		abilities: { 0: "Artillery Fortress" },
		heightm: 1.6,
		weightkg: 101.1,
		color: "Blue",
		eggGroups: ["Monster", "Water 1"],
	...
	typhlosion: {
		...
		abilities: { 0: "Adaptability", H: "Flash Fire", S: "Volcanic Core"},
		heightm: 1.7,
		weightkg: 79.5,
		color: "Yellow",
		prevo: "Quilava",
	...
	typhlosionmega: {
		...
		types: ["Fire", "Ghost"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 78, atk: 73, def: 88, spa: 169, spd: 95, spe: 131 },
		abilities: { 0: "Spiritual Flames" },
		heightm: 1.6,
		weightkg: 69.8,
		color: "Yellow",
		eggGroups: ["Field"],
	...
	lugia: {
		...
		abilities: { 0: "Pressure", H: "Multiscale", S: "Storm Sovereign" },
		heightm: 5.2,
		weightkg: 216,
		color: "White",
		tags: ["Restricted Legendary"],
	...
	hooh: {
		...
		abilities: { 0: "Pressure", H: "Regenerator", S: "Sacred Rebirth" },
		heightm: 3.8,
		weightkg: 199,
		color: "Red",
		tags: ["Restricted Legendary"],
