export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	blazikenmega: {
		...
		types: ["Fire", "Fighting"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 100, atk: 160, def: 80, spa: 130, spd: 80, spe: 100 },
	...
	spiritomb: {
		...
		abilities: { 0: "Pressure", H: "Infiltrator", S: "Wonder Guard" },
		heightm: 1,
		weightkg: 108,
		color: "Purple",
		eggGroups: ["Amorphous"],
	...
	garchompcynthia: {
		...
		types: ["Dragon", "Ground"],
		gender: "F",
		baseStats: { hp: 150, atk: 200, def: 115, spa: 130, spd: 120, spe: 160 },
